(custom-set-variables
 ...
 '(ansi-term-color-vector
   [unspecified "#343d46" "#d54e53" "#b9ca4a" "#e7c547" "#7aa6da" "#c397d8" "#7aa6da" "#dfe1e8"] t)
 ...
 '(package-selected-packages
   (quote
    (ripgrep web-mode company-anaconda anaconda-mode ranger vlf counsel-projectile ace-window counsel swiper ivy 0xc 0blayout railscasts-theme python-mode powerline-evil neotree iedit full-ack flycheck evil-magit elpy)))
 '(recentf-mode t)
 '(scroll-bar-mode nil)
 '(tool-bar-mode nil))
(custom-set-faces
...
;; Install my packages
(ensure-package-installed 'magit 'evil 'projectile 'railscasts-theme 'evil-magit 'neotree 'full-ack 'flycheck 'ivy 'swiper 'counsel 'ace-window 'counsel-projectile 'vlf 'ranger 'anaconda-mode 'company-anaconda 'web-mode)
(package-initialize)
...
(global-set-key (kbd "M-g") 'counsel-git)
